...
describe(`\x1b[46m bee-drawer \x1b[0m`, () => {
  describe(`the prop of "position"`, () => {
    ...
    it(`should include position_left`, async () => {
      wrapper.setProps({
        position: 'left'
      })
      await delay(10)
    ...
    it(`should include position_top`, async () => {
      wrapper.setProps({
        position: 'top'
      })
      await delay(10)
    ...
    it(`should include position_bottom`, async () => {
      wrapper.setProps({
        position: 'bottom'
      })
      await delay(10)
  ...
  describe(`the prop of "width"`, () => {
    it(`should be equal the set value`, async () => {
      const wrapper = _createWrapper({
        propsData: {
          width: '50%',
          value: true
